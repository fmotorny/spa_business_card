...
const routes: Routes = [
  ...
  { path: 'privacy-policy', component: PrivacyPolicyComponent, data: { title: 'Политика конфиденциальности — КП «Wellican Dom»' } },
  { path: 'usloviya-pokupki', component: UsloviyaPokupkiComponent, data: { title: 'Условия покупки — КП «Wellican Dom»' } },
];
